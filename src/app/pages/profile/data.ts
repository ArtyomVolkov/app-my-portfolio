import { Languages, Tools, Technologies, type ITechnology } from '@shared/dtos/develop';

export const LANGUAGES: ITechnology[] = [
...
export const PROJECTS = [
  {
    name: "Freelancer at Upwork",
    description: "Development of web and mobile applications for different clients. The main focus is on UI development, architecture design, performance optimization.",
    technologies: [
      Languages.typescript,
      Technologies.node,
      Technologies.express,
    ...
    responsibilities: [
      ...
      "Implementation of REST api services with Node.js, Express.",
